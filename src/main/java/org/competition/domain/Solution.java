...
/*    */ public class Solution {
    ...
    public Solution setName(String name) {
        this.name = name;
        return this;
    }

    public Solution setCreateTime(Date createTime) {
        this.createTime = createTime;
        return this;
    }

    public Solution setUpdateTime(Date updateTime) {
        this.updateTime = updateTime;
        return this;
    }

    public Solution setCreateUser(String createUser) {
        this.createUser = createUser;
        return this;
    }

    public Solution setUpdateUser(String updateUser) {
    ...
    public Solution setQueueId(Integer queueId) {
        this.queueId = queueId;
        return this;
    }

    public Solution setBackup1(String backup1) {
        this.backup1 = backup1;
        return this;
    }

    public Solution setBackup2(String backup2) {
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Solution;
    }
    ...
    public String toString() {
        return "Solution(id=" + getId() + ", name=" + getName() + ", createTime=" + getCreateTime() + ", updateTime=" + getUpdateTime() + ", createUser=" + getCreateUser() + ", updateUser=" + getUpdateUser() + ", content=" + getContent() + ", queueId=" + getQueueId() + ", backup1=" + getBackup1() + ", backup2=" + getBackup2() + ")";
    }
